#!/bin/bash
mkdir s3
aws s3 cp s3://devex-deploy/springboot-demo-app.zip /root/.jenkins/workspace/custom-actions/Sonarmy-default-app-2023-11-06-1699264227627/s3
unzip s3/springboot-demo-app.zip -d /root/.jenkins/workspace/custom-actions/Sonarmy-default-app-2023-11-06-1699264227627/s3
